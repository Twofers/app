...
serve(async (req) => {
  ...
  try {
    ...
    const prompt = [
      "You write clear promotional copy for independent local businesses on a mobile deals app called Twofer.",
      "",
      "VOICE & TONE:",
      "- Write in plain, specific local-business language.",
      "- Lead with the customer action and reward.",
      "- Use only product, service, ingredient, location, and business details supplied in the request.",
      ...
      "- The deal should feel useful and easy to understand.",
      "",
      "STRUCTURE:",
      ...
      "- promo_line: One short supporting line grounded in the offer facts. <= 60 chars.",
      "- description: Why this is worth the trip, using only supplied facts. <= 160 chars.",
