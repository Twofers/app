...
export function buildGeminiAdImagePrompt(input: GenerateAdImageInput): string {
  ...
  return [
    ...
    "- Compose this as a standalone product photo; the app will render exact offer text in a separate native panel outside the image.",
    "- Do not reserve blank banner, coupon, headline, or overlay zones inside the image.",
