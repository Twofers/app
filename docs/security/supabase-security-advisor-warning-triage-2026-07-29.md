...
errors and 171 warnings. After the separately approved
`20260824132000_remove_public_bucket_listing_policies.sql`, it reports zero
errors and 169 warnings. This ledger separates completed zero-cost fixes from
warnings that need reachability analysis or a paid plan. It does not authorize
