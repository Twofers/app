// D2 runner — executes the three database suites in order, each in its own
...
const suites = ["2a-purge-user-data.mjs", "2b-role-enforcement.mjs", "2c-rls-cross-tenant.mjs"];
