...
export const PRIVACY_POLICY_URL =
  process.env.EXPO_PUBLIC_PRIVACY_POLICY_URL ?? "https://www.twofer.app/privacy";

export const TERMS_OF_SERVICE_URL =
  process.env.EXPO_PUBLIC_TERMS_OF_SERVICE_URL ?? "https://www.twofer.app/terms";

export const SUPPORT_URL = process.env.EXPO_PUBLIC_SUPPORT_URL ?? "https://www.twofer.app/support";

export const DELETE_ACCOUNT_URL =
  process.env.EXPO_PUBLIC_DELETE_ACCOUNT_URL ?? "https://www.twofer.app/delete-account";
