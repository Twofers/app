...
// (artifacts/ai-hardening/2026-07-20/tier1/i0*/response.json). Removable tooling;
// not shipped logic. See docs/plans/poster-ad-quality-harness.md.
export type PosterGalleryCell = {
  id: string;
  label: string;
  // Real ad.poster payload (PosterDraftV1 superset); AdPosterCanvas reads copy_by_language/template_id.
  spec: unknown;
  kicker: string | null;
