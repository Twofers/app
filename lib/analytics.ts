...
export const AiAdsEvents = {
  ...
  REVISION_TAPPED: "ai_ads_revision_tapped",
  REVISION_SUCCEEDED: "ai_ads_revision_succeeded",
  REVISION_FAILED: "ai_ads_revision_failed",
  REVISION_LIMIT_HIT: "ai_ads_revision_limit_hit",
  REVISION_SUGGESTION_SELECTED: "ai_ads_revision_suggestion_selected",
