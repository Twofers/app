  ...
  return (
    <Modal visible={visible} animationType="fade" transparent accessibilityViewIsModal>
      ...
      >
        ...
        >
          <Text style={{ fontSize: 22, fontWeight: "900", letterSpacing: -0.3 }} numberOfLines={2} adjustsFontSizeToFit minimumFontScale={0.82} maxFontSizeMultiplier={1.15}>
            {t("consumerWallet.useDealTitle")}
          </Text>
          <Text style={{ marginTop: Spacing.sm, fontSize: 15, opacity: 0.72 }} numberOfLines={1} maxFontSizeMultiplier={1.15}>
            {businessName}
          </Text>
          <Text style={{ marginTop: 4, fontSize: 16, fontWeight: "700" }} numberOfLines={2} adjustsFontSizeToFit minimumFontScale={0.82} maxFontSizeMultiplier={1.15}>
            {dealTitle}
          </Text>
          <Text style={{ marginTop: Spacing.md, fontSize: 14, opacity: 0.65, lineHeight: 20 }} maxFontSizeMultiplier={1.15}>
